...
case "${1:-}" in nav) infer_seed=45 ;; *) exit 2 ;; esac
export RUN_ID=wan21_legacy_env42_infer${infer_seed}_${1}_20260916
export SESSION_NAME=$RUN_ID EXP_NAME=$RUN_ID
export OUTPUT_DIR=$ROOT_DIR/evaluate_results/libero/libero_all4_rothko_centerfrac05_2cam224_full_wan21_1_3b_1e-4/ckpt021700_vaeDecoderStep7498_replan8_ensembleOff_legacy_envSeed42_inferSeed${infer_seed}_${1}_20260916
