...
out=runs/libero_wan21_vae_cached_bs64_lr1p5e5_cosine4_hold1_20260914
if [ -e "$out" ]; then
...
exec /mnt/hwdata/cfy/miniconda3/envs/fastwam_libero/bin/python -u -m torch.distributed.run \
  --nproc_per_node=8 --master_addr=127.0.0.1 --master_port=29861 \
  ...
  --batch64-cosine4-hold --micro-batch 2 \
  --wandb --wandb-mode online --wandb-name libero_wan21_cached_bs64_lr1p5e5_cosine4_hold1_eval300_full500_20260914
