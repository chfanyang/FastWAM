...
out=runs/libero_wan21_vae_cached_bs64_w821_lr1e5_cosine4_hold1_gradlog_20260914
if [ -e "$out" ]; then
...
exec /mnt/hwdata/cfy/miniconda3/envs/fastwam_libero/bin/python -u -m torch.distributed.run \
  --nproc_per_node=8 --master_addr=127.0.0.1 --master_port=29862 \
  ...
  --center-loss-weight 8 --direction-loss-weight 2 --gripper-loss-weight 1 \
  --wandb --wandb-mode online --wandb-name libero_wan21_cached_bs64_w821_lr1e5_cosine4_hold1_gradlog_20260914
