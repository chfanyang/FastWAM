...
class FastWAMProcessor(BaseProcessor):
    ...
    def set_process_images(self, enabled: bool):
        self.process_images = bool(enabled)
        return self
    ...
    def preprocess(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        sample["idx"] = data["idx"]
        if data.get("raw_action"):
            sample["raw_action"] = data["raw_action"]
        if data.get("raw_state"):
            sample["raw_state"] = data["raw_state"]
