"""Opt-in full absolute LIBERO poses; independent of relative/mixed codecs."""
import torch
from .libero_rothko import LiberoRothkoCodec
from .rothko import _center_and_read_masks, quaternion_wxyz_to_matrix, matrix_to_quaternion_wxyz


class LiberoAllAbsoluteRothkoCodec(LiberoRothkoCodec):
    representation = 'libero_rothko_all_absolute'
