...
from fastwam.representations.vlabench_rothko import VLABenchRothkoCodec as LiberoRothkoCodec, VLABenchRothkoCodecConfig as LiberoRothkoCodecConfig
...
class VLABenchAbsoluteRay0Test(unittest.TestCase):
    def setUp(self):
        self.cfg = LiberoRothkoCodecConfig(image_height=32, image_width=96, horizontal_copies=3,
            tile_height=32, tile_width=32, outer_margin=2, boundary_margin=2)
        lo = torch.full((1, 3, 32, 96), -1.)
